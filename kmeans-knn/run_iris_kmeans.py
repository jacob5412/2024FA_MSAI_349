...
if __name__ == "__main__":
    ...
    print("--- Training K-means on Iris ---\n")
    kmeans.fit(training_set_features, "euclidean")
    predicted_labels = kmeans.predict(
        training_set_features, training_set_labels, "euclidean"
    )
    ...
    print("--- Testing K-means on Iris ---\n")
    predicted_labels = kmeans.predict(
        validation_set_features, validation_set_labels, "euclidean"
    )
    confusion_mat = create_confusion_matrix(

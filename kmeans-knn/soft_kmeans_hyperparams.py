...
logger = logging.getLogger("soft_kmeans-hyperparameter-selection")
...
def read_hyperparams(filepath):
    with open(filepath, "r", newline="") as csvfile:
        ...
        for row in reader:
            ...
            yield (k_components, pca_components, scaler, sharpness)
...
def get_best_hyperparams(
    ...
    for hyperparams in read_hyperparams(hyperparam_filepath):
        ...
        for _ in range(num_iterations):
            ...
            # Train Kmeans
            soft_kmeans = SoftKMeans(k_component, sharpness)
